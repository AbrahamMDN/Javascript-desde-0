//Declarar mi arreglo llamado frutas con varios tipos de frutas
let frutas = ["Manzana","Platano","Manzana","Guayaba","Platano","Guayaba","Manzana"];
...
for (let indice = 0; indice <frutas.length;indice++){
    ...
    if (conteoFrutas[fruta]){
        ...
        //Si la fruta no existe, inicilaizar el contador en 1
    }
}
